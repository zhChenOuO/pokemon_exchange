...
// RedisLock ...
func (c *ClusterClient) RedisLock(ctx context.Context, key, lockerID string, expireSeconds int) (bool, error) {
...
// RedisUnlock ...
func (c *ClusterClient) RedisUnlock(ctx context.Context, key, lockerID string) error {
